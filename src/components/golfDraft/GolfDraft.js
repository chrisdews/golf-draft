...
const draftId = useHardCodedContent ? 8000001 : 1000003;

function GolfDraft({user}) {
  ...
  // const createDraft = async (userId = 'testUser') => {
  //   const newDraftRef = database.ref("drafts/").push({
  //     admin: userId,
  //     title: "Announcing COBOL, a New Programming Language"
  //    });
     
  //    // Get the unique ID generated by push() by accessing its key
  //    const draftId = newDraftRef.key;
