...
interface TournamentInfoProps {
  nextPgaEvent: Pick<Fixture, 'name' | 'course' | 'country' | 'start_date'> | null | undefined
}

function TournamentInfo({ nextPgaEvent }: TournamentInfoProps) {
  const timeHelper = (): string | null => {
